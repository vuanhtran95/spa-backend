...
Route::post('/v1/employees', 'EmployeeController@create');
...
// Intake form
Route::post('/v1/intakes', 'IntakeController@create');
...
Route::post('/v1/services', 'ServiceController@create');
...
Route::post('/v1/variants', 'VariantController@create');
...
Route::post('/v1/service-categories', 'ServiceCategoryController@create');


// Customer
Route::post('/v1/customers', 'CustomerController@create');
...
// Invoice
Route::post('/v1/invoice', 'InvoiceController@create');
Route::put('/v1/invoice/approve/{id}', 'InvoiceController@approve');
Route::get('/v1/invoice/{customerId}', 'InvoiceController@getInvoiceByCustomerId');